    ...
    <section id="technologies mt-4 my-5">
        ...
        <div class="container technology-block">
          <div class="col-lg-12 col-sm-12 d-flex justify-content-center">
                <div class="card border-0 mb-5 rounded-20" style="background: #064174; color: #064174">
                    <div class="card-body">
                        ...
                        <div class="col-xl-12 col-md-12 col-sm-12  justify-center">
                            <div class="card" style="background: #064174; color: #064174">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table" style="background: #064174;">
                                            <thead style="background: #064174; border: 0px;">
                                            <tr>
                                                <th>Service</th>
                                                <th>Phone</th>
                                                <th>SMS</th>
                                            ...
                                            @forelse($orders as $data)
                                                <tr>
                                                    <td style="background: #064174; font-size: 12px; color: white;">{{ $data->service }}</td>
                                                    <td style="background: #064174; font-size: 12px; color: white;">{{ $data->phone }}
                                                    </td>


                                                    @if($data->type == 4)
                                                        @if($data->sms != null)
                                                            <td style="background: #064174; font-size: 12px; color:rgb(0, 0, 0)">{{ $data->sms }}
                                                            </td>
                                                        @else
                                                            <style>
                                                            ...
                                                            <td style="background: #064174; font-size: 12px; color: white">

                                                                <div>
                                                                    <input style="background: #064174;" class="border-0 "
                                                        ...
                                                        @endif
                                                            ...
                                                            <td>
                                                                @if ($data->status == 1)
                                                                    <span
                                                                        style="background: orange; border:0px; font-size: 10px; color: black;"
                                                    ...
                                                    @elseif($data->type == 3)
                                                        ...
                                                        @if($data->sms != null)
                                                            <td style="background: #064174; font-size: 12px;">{{ $data->sms }}
                                                            </td>
                                                        @else
                                                            <style>
                                                                /* HTML: <div class="loader"></div> */
                                                    ...
                                                    @elseif($data->type == 2)
                                                        ...
                                                        @if($data->sms != null)
                                                            <td style="background: #064174; font-size: 12px; color: #ffffff">{{ $data->sms }}
                                                            </td>
                                                        @else
                                                            <style>
                                                                /* HTML: <div class="loader"></div> */
