                                                ...
                                                <div class="table-responsive ">
                                                    <table class="table">
                                                        ...
                                                        @forelse($verification as $data)
                                                            <tr>
                                                                <td style="font-size: 12px; color: black">{{ $data->id }}</td>
                                                                <td style="font-size: 12px; color: black">{{ $data->service }}</td>
                                                                <td style="font-size: 12px; color: black"><a
                                                                        href="receive-sms?phone={{ $data->id }}">{{ $data->phone }} </a>
                                                                </td>
                                                                <td style="font-size: 12px; color: black">{{ $data->sms }}</td>
